...
class MapPage extends Component {
    ...
    handleCalculate = async () => {
        ...
        const { sessionId } = this.props.match.params;
        const calculateResponse = await api.getCalculate(sessionId);
        console.log("calculateResponse", calculateResponse);
                ...
                {!this.state.loading && (
                    <Fragment>
                        ...
                        <Sidebar
                            ...
                            updatePerson={(user) =>
                                this.handleUpdatePerson(user)
                            }
                            updateSession={(session) =>
                                this.handleUpdateSession(session)
                            }
                        />
                    </Fragment>
                )}
